import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as s,o as p,c,d as a,a as n,b as l,e}from"./app-CgdPMHM7.js";const r={},u=e(`<h2 id="搭建项目框架" tabindex="-1"><a class="header-anchor" href="#搭建项目框架"><span>搭建项目框架</span></a></h2><p>本项目使用 Go语言：一种编译型、并发型、垃圾回收型、面向对象的编程语言，具有简洁、高效、可靠等特点。主要使用的技术栈有：</p><ul><li>gin框架：一种基于Go语言的轻量级、高性能、支持中间件的Web框架，具有快速、灵活、易用等特点。</li><li>http包：Go语言标准库中的一个包，提供了创建和处理HTTP协议的客户端和服务器端的功能。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>authset
├── api
│   └── v1
│       ├── api.go
│       └── user.go
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这段代码对整体项目的影响主要有：</p><ul><li>它提供了一个统一的入口函数，方便在其他地方调用和创建HTTP服务器。</li><li>它实现了对gin框架和服务器配置的封装，简化了HTTP服务器的创建过程。</li><li>它增加了项目的可读性和可维护性，因为它使用了清晰的命名和注释。</li></ul><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="api-层" tabindex="-1"><a class="header-anchor" href="#api-层"><span>API 层</span></a></h2><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// api/v1/api.go</span>
...
<span class="token keyword">func</span> <span class="token function">NewHandle</span><span class="token punctuation">(</span>usercase <span class="token operator">*</span>services<span class="token punctuation">.</span>Usercase<span class="token punctuation">)</span> <span class="token operator">*</span>Handle <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这段代码定义了一个名为 <code>Handle</code> 的结构体，它包含一个指向 <code>services.Usercase</code> 结构体的指针。<code>Usercase</code> 是一个服务层结构体，用于处理业务逻辑。</p><p><code>NewHandle</code> 函数是一个构造函数，它接受一个 <code>services.Usercase</code> 结构体指针作为参数，并返回一个 <code>Handle</code> 结构体指针。在函数内部，使用传入的 <code>usercase</code> 参数创建一个新的 <code>Handle</code> 结构体，并将其返回。</p><p><code>ProviderSet</code> 是一个 <code>wire.Set</code>，它使用 <code>NewHandle</code> 函数创建一个新的 <code>Handle</code> 结构体。这个 <code>ProviderSet</code> 可以在依赖注入中使用，用于提供 <code>Handle</code> 结构体的实例。</p><p>总的来说，这段代码定义了一个 <code>Handle</code> 结构体和一个 <code>NewHandle</code> 函数，用于创建 <code>Handle</code> 结构体的实例。这个结构体包含一个指向 <code>services.Usercase</code> 结构体的指针，用于处理业务逻辑。<code>ProviderSet</code> 是一个依赖注入的集合，用于提供 <code>Handle</code> 结构体的实例。</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// api/v1/user.go</span>
<span class="token keyword">package</span> v1
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料"><span>参考资料</span></a></h2>`,16),v={href:"https://github.com/opsets/authset",target:"_blank",rel:"noopener noreferrer"},m=n("li",null,"[]",-1);function k(g,b){const t=s("Mermaid"),o=s("ExternalLinkIcon");return p(),c("div",null,[u,a(t,{id:"mermaid-22",code:"eJxVkEsOgzAMRPecggvQ3qAnoIvSpdVFCC5kwadJqFQh7t54EkBsxpN5juK4tWrq8rLKemUGErm04ysviluux+FtWopF0ixawFo5JhEAMYgb5RWJIBaD2LH9Gs2ONgO8HfYWtmhgu2O2gHacfYCxAEYL2Hk/kQiAmDS+dWF4G98Sg9ibnsNdShUwefA5PEsiIGLiBPyZ2XlK9bp3pOD0zfPPZAvHKpp6uf+ej3I9Iq10x0vFjXFr9gcmy4q1"}),d,n("ul",null,[n("li",null,[n("a",v,[l("Github 仓库"),a(o)])]),m])])}const T=i(r,[["render",k],["__file","authset.html.vue"]]),q=JSON.parse('{"path":"/project/authset.html","title":"单点登录身份鉴权系统 authset 源码阅读","lang":"zh-CN","frontmatter":{"title":"单点登录身份鉴权系统 authset 源码阅读","icon":"article","date":"2023-04-01T22:56:13.000Z","category":["项目实战"],"tag":["authset"],"description":"搭建项目框架 本项目使用 Go语言：一种编译型、并发型、垃圾回收型、面向对象的编程语言，具有简洁、高效、可靠等特点。主要使用的技术栈有： gin框架：一种基于Go语言的轻量级、高性能、支持中间件的Web框架，具有快速、灵活、易用等特点。 http包：Go语言标准库中的一个包，提供了创建和处理HTTP协议的客户端和服务器端的功能。 我会尽力根据目录树说明...","head":[["meta",{"property":"og:url","content":"https://jiejaitt.tech/project/authset.html"}],["meta",{"property":"og:title","content":"单点登录身份鉴权系统 authset 源码阅读"}],["meta",{"property":"og:description","content":"搭建项目框架 本项目使用 Go语言：一种编译型、并发型、垃圾回收型、面向对象的编程语言，具有简洁、高效、可靠等特点。主要使用的技术栈有： gin框架：一种基于Go语言的轻量级、高性能、支持中间件的Web框架，具有快速、灵活、易用等特点。 http包：Go语言标准库中的一个包，提供了创建和处理HTTP协议的客户端和服务器端的功能。 我会尽力根据目录树说明..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-06-07T07:18:19.000Z"}],["meta",{"property":"article:author","content":"JIeJaitt"}],["meta",{"property":"article:tag","content":"authset"}],["meta",{"property":"article:published_time","content":"2023-04-01T22:56:13.000Z"}],["meta",{"property":"article:modified_time","content":"2023-06-07T07:18:19.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"单点登录身份鉴权系统 authset 源码阅读\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-04-01T22:56:13.000Z\\",\\"dateModified\\":\\"2023-06-07T07:18:19.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"JIeJaitt\\",\\"url\\":\\"https://jiejaitt.tech\\"}]}"]]},"headers":[{"level":2,"title":"搭建项目框架","slug":"搭建项目框架","link":"#搭建项目框架","children":[]},{"level":2,"title":"API 层","slug":"api-层","link":"#api-层","children":[]},{"level":2,"title":"参考资料","slug":"参考资料","link":"#参考资料","children":[]}],"git":{"createdTime":1685972912000,"updatedTime":1686122299000,"contributors":[{"name":"JIeJaitt","email":"498938874@qq.com","commits":1}]},"readingTime":{"minutes":10.97,"words":3292},"filePathRelative":"project/authset.md","localizedDate":"2023年4月1日","excerpt":"<h2>搭建项目框架</h2>\\n<p>本项目使用 Go语言：一种编译型、并发型、垃圾回收型、面向对象的编程语言，具有简洁、高效、可靠等特点。主要使用的技术栈有：</p>\\n<ul>\\n<li>gin框架：一种基于Go语言的轻量级、高性能、支持中间件的Web框架，具有快速、灵活、易用等特点。</li>\\n<li>http包：Go语言标准库中的一个包，提供了创建和处理HTTP协议的客户端和服务器端的功能。</li>\\n</ul>\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code>authset\\n├── api\\n│   └── v1\\n│       ├── api.go\\n│       └── user.go\\n├── config\\n│   ├── config.go\\n│   ├── http.go\\n│   ├── mysql.go\\n│   └── redis.go\\n├── config.yaml\\n├── data\\n│   ├── base.go\\n│   ├── data.go\\n│   └── user.go\\n├── go.mod\\n├── go.sum\\n├── main.go\\n├── middlewares\\n│   ├── cors.go\\n│   └── timeout.go\\n├── request\\n│   └── user.go\\n├── router\\n│   ├── router.go\\n│   └── user.go\\n├── server\\n│   ├── http.go\\n│   └── server.go\\n├── services\\n│   ├── services.go\\n│   └── user.go\\n├── wire.go\\n└── wire_gen.go\\n</code></pre></div>","autoDesc":true}');export{T as comp,q as data};
